...
const correoConfirmation = async (to, cartones) => {
  try {
    const content = await new pdfService.CartonesPdf(cartones);
    await transporter.sendMail({
      from: '"Bingoloteando" <nicoflores.dev@gmail.com>', // sender address
      to, // list of receivers
      ...
      html: `
      <b>Hola!</b>
      Confirmamos la compra de tus cartones para el bingo✨.
      Además adjuntamos un archivo <b>pdf</b>
      en donde encontrarás los cartones de tu compra.
      <br>
      De parte de todo el equipo organizador,
      te damos las gracias por ayudar colaborando a esta causa.
      <br><br>
      atte: equipo técnico 
      <b>Bingoloteando</b>`, // html body
